...
The focus for Day 11 is to **get comfortable with the I2C communication protocol** by interfacing with the AHT20 (humidity and temperature detector).
...
2) ([Answer](./Answers/ReadOLED.ino)) OLED Display - Add your OLED display and program it to display the RH% and Temperature data on the screen
